...
public class TestEventChainForShortAlternative3 : IClassFixture<CustomWebApplicationFactory<Program>>
{
    private readonly WebApplicationFactory<Program> _factory;
    private readonly ITestOutputHelper _testOutputHelper;

    public TestEventChainForShortAlternative3(CustomWebApplicationFactory<Program> factory, ITestOutputHelper testOutputHelper)
    {
        _factory = factory;
    ...
    public async Task Schema_2_Short()
    {
        ...
        var list = new List<Tuple<int, int, int>>() { new(2, 2, 2) };
