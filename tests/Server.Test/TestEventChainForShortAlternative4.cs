...
public class TestEventChainForShortAlternative4 : IClassFixture<CustomWebApplicationFactory<Program>>
{
    private readonly WebApplicationFactory<Program> _factory;
    private readonly ITestOutputHelper _testOutputHelper;

    public TestEventChainForShortAlternative4(CustomWebApplicationFactory<Program> factory, ITestOutputHelper testOutputHelper)
    {
        _factory = factory;
    ...
    public async Task Schema_2_Short()
    {
        ...
        var list = new List<Tuple<int, int, int>>() { new(2, 1, 1) };
